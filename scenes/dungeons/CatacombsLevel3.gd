...
const COLOR_ALTAR = Color(0.6, 0.55, 0.5)
...
func position_camera_at_spawn():
	camera.translation = Vector3(11 - 12, 1.6, 22 - 12)
...
func perform_ritual():
	...
	show_message("Moonlight floods the chamber.\n\nYarikh's blessing fills you with power.\n\nYou have been awakened.")
